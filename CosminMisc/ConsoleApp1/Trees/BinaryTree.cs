...
namespace ConsoleApp1.Trees
{
    ...
    public class BinaryTree<T> where T : IComparable<T>
    {
        ...
        public void Delete(T value, bool rebalanceTree) {
            ...
            else if (foundNode.Left != null && foundNode.Right != null) //This is a node with two hildren
            {
                if (leftOrRightNode) {
            ...
            else if (foundNode.Left != null || foundNode.Right != null) //This is a node with a singlechild
            {
        ...
        private void Insert(BinaryTreeNode<T> node, ref BinaryTreeNode<T> parent) {
            if (parent == null) {
                ...
                if (node.Data.CompareTo(parent.Data) < 0) {
                    ...
                    if (root.Data.CompareTo(parent.Data) == 0)
                        CountLeft++;
                }
